...
import { navItems, socialLinks } from '../../../config/ui-config';
...
const Header: React.FC = () => {
  ...
  // Get the background color based on theme mode and scroll state
  const transparentBgColor = mode === 'dark' 
    ? 'rgba(18, 18, 18, 0.8)' // Dark mode transparent background
    : 'rgba(255, 255, 255, 0.8)'; // Light mode transparent background
          ...
          >
            ...
            <IconButton
              ...
              sx={{
                ...
                top: 8,   // Offset from the top edge
                zIndex: 1201,
              }}
            >
              <MenuIcon />
