...
export const aboutData = [
  // WhoAmI tab (previously About Me)
  {
    ...
    pictures: [createAboutImage(WhoamiImage, 'Vincent Göke', 'center bottom 30%')],
    content: (
      <>
        <Typography
          variant="h4"
        ...
        <Typography variant="body1" paragraph>
          Hi! I'm Vincent Göke, a Human-Computer Interaction Master's graduate, sound designer, and
          interaction technologist. My work is centered around designing{' '}
          <strong>emotion-driven experiences </strong> through{' '}
          <strong>affective haptics, UX research, and multi-sensory interaction design</strong>.
        </Typography>
        <Typography variant="body1" paragraph>
          With a background in media informatics and audio design, I transitioned into{' '}
          <strong>haptic interaction design</strong>—an underexplored but promising field that
          bridges touch, sound, and technology to create intuitive and immersive user experiences.
        </Typography>
        <Typography variant="body1" paragraph>
          <strong>Beyond Work</strong>: Outside of my professional work, I produce and mix music
          under the aliases <strong>Din-Z</strong> and <strong>Superior Motive</strong>, with roots
          in HipHop production and audio post-production since 2015. When I’m not designing
          interactions or making music, you’ll likely find me on the pitch or in the stands — I’m a
          lifelong <strong>football fan</strong>, former player, and dedicated FC Schalke 04
          supporter.
        </Typography>
      </>
    ),
        ...
        <Grid container spacing={3} sx={{ mb: 4 }}>
          <Grid item xs={12} sm={6}>
            ...
            <Typography variant="body2" paragraph>
              UI/UX Design, Interaction Design, Wireframing, Prototyping, Visual Design, User Flows,
          ...
          <Grid item xs={12} sm={6}>
            ...
            <Typography variant="body2" paragraph>
              ...
              Mobile Development, Sensor Integration, Haptic Feedback, Audio Programming
            </Typography>
          </Grid>
          <Grid item xs={12} sm={6}>
            <Box sx={{ display: 'flex', alignItems: 'flex-start', mb: 1 }}>
            ...
            >
              <Box sx={{ display: 'flex', alignItems: 'flex-start', mb: 0 }}>
                ...
                <Box sx={{ lineHeight: 1 }}>
                  <Typography
                    variant="h6"
                    sx={{ color: 'primary.main', fontSize: '0.95rem', lineHeight: 1.1 }}
                  >
                    UX Intern
                  </Typography>
                  <Typography
                    variant="subtitle2"
                    sx={{ color: 'text.secondary', fontSize: '0.85rem', lineHeight: 1.1, mt: -0.3 }}
                  >
                    DJay Munich | 2022
                  </Typography>
                </Box>
              ...
              <Typography
                variant="body2"
                sx={{ mt: 0, mb: 0, fontSize: '0.85rem', lineHeight: 1.1 }}
              >
                Conducted user research and prototyped new interaction models for music-related
                applications.
              </Typography>
              <Box
                component="ul"
                sx={{ paddingLeft: '1.2rem', mt: 0, mb: 0, pl: 1, flex: 1, lineHeight: 0.9 }}
              >
              ...
              <Box sx={{ display: 'flex', alignItems: 'flex-start', mb: 0 }}>
                ...
                <Box sx={{ lineHeight: 1 }}>
                  <Typography
                    ...
                    sx={{ color: 'primary.main', fontSize: '0.95rem', lineHeight: 1.1 }}
                  >
                    IT & Podcast Production Support
                  </Typography>
                  <Typography
                    variant="subtitle2"
                    sx={{ color: 'text.secondary', fontSize: '0.85rem', lineHeight: 1.1, mt: -0.3 }}
                  >
                    University Hospital Munich | 2020–2022
                  </Typography>
                </Box>
              </Box>
              <Typography
                ...
                sx={{ mt: 0, mb: 0, fontSize: '0.85rem', lineHeight: 1.1 }}
              >
                Provided technical support and developed an audio production pipeline for podcast
                content.
              </Typography>
              <Box
                component="ul"
          ...
          <Grid item xs={12}>
            ...
            >
              <Box sx={{ display: 'flex', alignItems: 'flex-start', mb: 0 }}>
                ...
                <Box sx={{ lineHeight: 1 }}>
                  <Typography
                    ...
                    sx={{ color: 'primary.main', fontSize: '0.95rem', lineHeight: 1.1 }}
                  >
                    Freelance Audio Producer / Sound Designer
                  </Typography>
                  <Typography
                    variant="subtitle2"
                    sx={{ color: 'text.secondary', fontSize: '0.85rem', lineHeight: 1.1, mt: -0.3 }}
              ...
              <Typography
                ...
                sx={{ mt: 0, mb: 0, fontSize: '0.85rem', lineHeight: 1.1 }}
              >
                Created original music compositions (Superior Motive, Din-Z), mixed audio for
                projects, and collaborated with artists.
              </Typography>
              <Box
                component="ul"
                sx={{ paddingLeft: '1.2rem', mt: 0, mb: 0, pl: 1, flex: 1, lineHeight: 0.9 }}
      ...
      <>
        ...
        <Grid container spacing={3} sx={{ mb: 4 }}>
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              <Box sx={{ display: 'flex', alignItems: 'flex-start', mb: 1 }}>
                <SchoolIcon color="primary" sx={{ mr: 2, mt: 0 }} />{' '}
                <Box>
              ...
              <Typography variant="body2" sx={{ mt: 1.5 }}>
                Specialized in haptic interaction design and multi-sensory user experience. Master's
                thesis on emotion-driven haptic feedback design methodologies.
              </Typography>
            </Box>
          </Grid>
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              <Box sx={{ display: 'flex', alignItems: 'flex-start', mb: 1 }}>
                <MenuBookIcon color="primary" sx={{ mr: 2, mt: 0 }} />{' '}
                <Box>
                  <Typography variant="h6" sx={{ color: 'primary.main' }}>
              ...
              <Typography variant="body2" sx={{ mt: 1.5 }}>
                Focused on user interface design, web technologies, and interactive systems.
                Bachelor's thesis on trust in autonomous vehicle interfaces.
              </Typography>
            </Box>
          </Grid>
          ...
          <Grid item xs={12}>
            ...
            >
              <Box sx={{ display: 'flex', alignItems: 'flex-start', mb: 1 }}>
                <AutoStoriesIcon color="primary" sx={{ mr: 2, mt: 0 }} />{' '}
                <Box>
                  <Typography variant="h6" sx={{ color: 'primary.main' }}>
                    Diploma in Audio Design
                  </Typography>
                  <Typography variant="subtitle2" sx={{ color: 'text.secondary' }}>
              ...
              <Typography variant="body2" sx={{ mt: 1.5 }}>
                Professional training in audio production, sound design, and music technology with
                emphasis on electronic music production.
              </Typography>
            </Box>
          </Grid>
        </Grid>
...
export const renderSkillChip = (skill) => <Chip key={skill} label={skill} sx={{ m: 0.5 }} />;
