...
class ErrorBoundaryBase extends Component {
  ...
  render() {
    ...
    const { componentName = 'Component', fallback, errorStyles, children } = this.props;
      ...
      return (
        ...
        >
          ...
          {showDetails && (
            <Paper
              elevation={2}
              sx={{ p: 2, width: '100%', maxWidth: '800px', overflow: 'auto', textAlign: 'left' }}
            >
              ...
              <Typography
                variant="body2"
                component="div"
                sx={{ fontFamily: this.props.theme.typography.fontFamily, fontSize: '0.75rem' }}
              >
                <Box
                  component="pre"
                  sx={{
