...
const adhdeer = {
  ...
  details: (
    <>
      ...
      <Typography variant="h3">Motivation & Team Context</Typography>
      <Typography variant="body1" paragraph>
      ...
      <Typography variant="h3">Defining the Problem</Typography>
      ...
      <Typography variant="h3">Research & Empathy Phase</Typography>
      <Typography variant="body1" paragraph>
      ...
      <Typography variant="h3">Core Dimensions & Functionalities</Typography>
      <Typography variant="body1" paragraph>
      ...
      <Typography variant="h3">Outcomes & User Feedback</Typography>
      <Typography variant="body1" paragraph>
  ...
  layoutSuggestions: {
    sectionOrder: ["overview", "motivation", "problem", "research", "dimensions", "prototype", "outcomes", "future"],
    specialSections: [
      {
        type: "prototypeShowcase",
        title: "App Features",
        layout: "three-column",
        content: "Demonstration of the main app features: daily planner, mood tracker, and education modules"
      },
      {
        type: "userPersonas",
        title: "Target Users",
        layout: "side-by-side",
        content: "Visualization of child user and parent user personas and needs"
      }
    ]
  }
};
