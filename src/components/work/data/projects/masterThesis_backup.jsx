  ...
  sections: [
    ...
    },
    {
      ...
      content: (
        <>
          <Typography variant="body1" paragraph>
            The research followed a systematic approach combining literature review, iterative prototyping, and empirical validation through workshop studies.
          </Typography>
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, mt: 3 }}>
            <Card
              ...
              sx={{
                ...
                background: 'linear-gradient(135deg, rgba(150, 132, 69, 0.05) 0%, rgba(150, 132, 69, 0.02) 100%)'
              }}
            >
              <CardContent>
                <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                  <Avatar sx={{ bgcolor: 'primary.main', mr: 2, width: 32, height: 32 }}>
                    <Typography variant="caption" sx={{ fontSize: '0.75rem', fontWeight: 'bold' }}>1</Typography>
                  </Avatar>
                ...
                <Box sx={{ pl: 5 }}>
                  <Chip label="Literature Review" size="small" color="primary" variant="outlined" sx={{ mr: 1, mb: 1 }} />
                  <Chip label="Method Selection" size="small" color="primary" variant="outlined" sx={{ mr: 1, mb: 1 }} />
            ...
            <Card
              ...
              sx={{
                ...
                background: 'linear-gradient(135deg, rgba(161, 227, 216, 0.05) 0%, rgba(161, 227, 216, 0.02) 100%)'
              }}
            >
              <CardContent>
                <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                  <Avatar sx={{ bgcolor: 'secondary.main', mr: 2, width: 32, height: 32 }}>
                    <Typography variant="caption" sx={{ fontSize: '0.75rem', fontWeight: 'bold' }}>2</Typography>
                  </Avatar>
                ...
                <Box sx={{ pl: 5 }}>
                  <Chip label="Hapticlabs DevKit" size="small" color="secondary" variant="outlined" sx={{ mr: 1, mb: 1 }} />
                  <Chip label="On-Body Testing" size="small" color="secondary" variant="outlined" sx={{ mr: 1, mb: 1 }} />
                  <Typography variant="body2" sx={{ mt: 1 }}>
              ...
              <CardContent>
                <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                  <Avatar sx={{ bgcolor: 'success.main', mr: 2, width: 32, height: 32 }}>
                    <Typography variant="caption" sx={{ fontSize: '0.75rem', fontWeight: 'bold' }}>3</Typography>
                  </Avatar>
                ...
                <Box sx={{ pl: 5 }}>
                  <Chip label="Pattern Analysis" size="small" color="success" variant="outlined" sx={{ mr: 1, mb: 1 }} />
                  <Chip label="Toolkit Creation" size="small" color="success" variant="outlined" sx={{ mr: 1, mb: 1 }} />
                  <Typography variant="body2" sx={{ mt: 1 }}>
