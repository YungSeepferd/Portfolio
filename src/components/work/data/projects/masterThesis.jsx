...
const masterThesis = {
  ...
  description:
    'A structured methodology for prototyping emotional haptic feedback using the Circumplex Model of Affect.',
  ...
  sections: [
    // 1. Overview
    {
      ...
      content: (
        <Typography variant="body1" paragraph>
          ...
          designers in crafting emotionally resonant haptic feedback systems. The research bridges
          the gap between emotion theory and practical haptic design through structured workshop
          methodologies and technical implementations, specifically targeting accessibility and
          intuitive use within educational contexts.
        </Typography>
      ),
    ...
    // 2. Problem
    {
      ...
      content: (
        <>
          <Typography variant="body1" paragraph>
            Despite advancements in affective computing, novice interaction designers frequently
            encounter significant difficulties in effectively translating abstract emotions into
            tangible tactile experiences. Key challenges include:
          </Typography>
          <Box
            component="ul"
            sx={{
          ...
          >
            The thesis aimed explicitly at overcoming these obstacles through an educational,
            user-centered toolkit that fosters emotional awareness, iterative prototyping, and
    ...
    // 3. Methodology
    {
      ...
      content: (
        <>
          ...
          >
            The toolkit was validated through a structured workshop consisting of clearly delineated
            phases:
          </Typography>
          <Box
            component="ol"
          ...
          >
            <li>
              ...
              >
                <strong>Emotional Framework Introduction:</strong> Participants engaged with
                foundational emotional theories including the Circumplex Model of Affect and Delft's
                Emotion Typology, establishing a common conceptual basis.
              </Typography>
            </li>
            <li>
              <Typography
              ...
              >
                <strong>Embodied Metaphor Elicitation and Body Mapping:</strong> Utilizing personal
                emotional objects and detailed body maps, participants identified emotional hotspots
                and physical sensations, crucial for actuator placement in haptic designs.
              </Typography>
            </li>
            <li>
              <Typography
              ...
              >
                <strong>Tandem On-body Prototyping:</strong> Through collaborative and iterative
                prototyping sessions with the Hapticlabs DevKit, participants created and refined
                haptic prototypes in real-time, alternating roles between designer and tester.
              </Typography>
            </li>
            <li>
              <Typography
              ...
              >
                <strong>Reflective Feedback:</strong> Surveys and structured group discussions
                facilitated critical evaluation of the prototypes' emotional resonance, usability,
        ...
        <>
          ...
          >
            <li>
              ...
              >
                <strong>Visual Templates:</strong> For embodied metaphor elicitation and emotion
                categorization
              </Typography>
            </li>
            <li>
              ...
              >
                <strong>Body Maps:</strong> Visual templates facilitating the identification of
                emotional sensations across the body
              </Typography>
            </li>
            <li>
              <Typography
              ...
              >
                <strong>Physical Prototyping Resources:</strong> The Hapticlabs DevKit with
                actuators (ERM, LRA, VC) and tactile materials for rapid experimentation
              </Typography>
            </li>
            <li>
              <Typography
              ...
              >
                <strong>Interactive Digital Workspace (Miro):</strong> Enhancing documentation,
                remote collaboration, and iterative refinement
              </Typography>
            </li>
          </Box>
        </>
    ...
    // 5. Outcomes
    {
      ...
      content: (
        <>
          ...
          >
            This research contributed a practical, accessible framework for novice haptic designers,
            significantly democratizing affective haptic design within educational and professional
          ...
          >
            <li>
              ...
              >
                Participants successfully translated abstract emotional concepts into tangible,
                emotionally resonant haptic feedback
              </Typography>
            </li>
            <li>
              <Typography
              ...
              >
                ...
                creating richer, more personally meaningful designs
              </Typography>
            </li>
            <li>
              <Typography
              ...
              >
                Identified technical challenges and subjective emotional interpretations provided
                critical insights for future toolkit refinement
              </Typography>
            </li>
          </Box>
          <Typography
          ...
          >
            Emotions can be systematically mapped to haptic parameters using the Circumplex Model of
            Affect.
          </Typography>
          <Typography
            variant="body1"
          ...
          >
            Iterative testing revealed the importance of temporal patterns in emotional haptic
            feedback.
          </Typography>
          <Typography
            variant="body1"
